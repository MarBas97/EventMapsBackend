...
conn.execute('CREATE TABLE IF NOT EXISTS mapPointers (pointerId Integer PRIMARY KEY, long REAL NOT NULL, lan REAL NOT NULL, description TEXT, likes INTEGER, createdOn TEXT NOT NULL, userId INTEGER NOT NULL, FOREIGN KEY(userId) REFERENCES users(userId))')
cur = conn.cursor()
